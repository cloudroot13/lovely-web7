...
export default function NotFound() {
  return (
    <main className="relative min-h-[100dvh] overflow-hidden bg-[#0b0b0b] px-4 py-8 text-white sm:px-6">
      ...
      <section className="relative mx-auto flex min-h-[calc(100dvh-4rem)] w-full max-w-md flex-col items-center justify-center rounded-3xl border border-white/10 bg-black/55 p-6 text-center shadow-[0_18px_60px_rgba(0,0,0,0.55)] backdrop-blur-sm">
        ...
        <div className="relative mt-7 w-full">
          <div className="mx-auto max-w-[290px] rounded-2xl border border-white/15 bg-[#171717] px-4 py-3 text-sm font-semibold text-zinc-100 shadow-[0_10px_26px_rgba(0,0,0,0.45)] sm:text-base">
        ...
        <img src={pensadorMascot} alt="Mascote cupido pensador" className="mt-5 w-[220px] max-w-full object-contain sm:w-[250px]" />
